...
from wenet.transformer.hypermixing import HyperMixing
from wenet.transformer.sh_attention import sh_attention
...
WENET_ATTENTION_CLASSES = {
    ...
    "hypermixing": HyperMixing,
    "sh_attn": sh_attention
}
